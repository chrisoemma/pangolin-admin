    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-600 mt-2">Department Details</p>
        </div>
        <Link
          to={`/master-data/departments/${department.id}/edit`}
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-gray-900 mt-1">{department.faculty?.name || department.faculty_id || '-'}</p>
          </div>
